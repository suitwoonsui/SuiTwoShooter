...
import { getApiKeyForEcosystemApp, getCorridorCapabilityObjectIdFromEnv, getCorridorAdminCapabilityObjectIdFromEnv, getEcosystemIdFromEnv, getAppIdFromEnv, getSonarClient, buildBatchViaChannel, platformTxClient, platformMilestonesClient } from '@/lib/services/platform/client/platform-client';
...
export function getPlatformEcosystemApiKey(): string {
  ...
  const appFromEnv = getAppIdFromEnv() || PLATFORM_APP_ID;
  return getApiKeyForEcosystemApp(ecoFromEnv, appFromEnv) || '';
}

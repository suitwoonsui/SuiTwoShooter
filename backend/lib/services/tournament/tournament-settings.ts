...
//
// In-process cache: first successful read is cached until `invalidateTournamentSettingsCache()` or `setTournamentSettings()`.
// If Helm or tournament-settings.json changes **outside** this app, call `invalidateTournamentSettingsCache()` or restart
// workers (admin settings PUT ends with invalidate after `setTournamentSettings`). Rare change — see docs/CACHING_PLAN.md Phase 1.
// ==========================================

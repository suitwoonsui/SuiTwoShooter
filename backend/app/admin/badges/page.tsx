                ...
                <div>
                  ...
                  {updateImageResult.requiresPlayerSignature && (
                    <p style={{ marginTop: '0.75rem', fontSize: '0.9rem' }}>
                      The player must sign the returned transaction with their wallet (that address as sender). The
                      admin wallet cannot submit this upgrade on their behalf.
                    </p>
                  )}
                </div>
              ) : (
        ...
        {action === 'mint' ? (
          <>
            <div>
              ...
              <p style={{ marginBottom: '0.5rem', fontSize: '0.85rem', color: '#555' }}>
                The soulbound NFT is minted to your <strong>game admin wallet</strong> (payer/owner). If you enter another
                address here, it is stored in on-chain metadata as <code>grant_target_player</code> for support; it does
                not receive the NFT.
              </p>
              <input
                type="text"

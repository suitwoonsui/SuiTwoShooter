  ...
  async (request: NextRequest) => {
    ...
    if (milestones && Array.isArray(milestones) && milestones.length > 0) {
      ...
      return {
        ...
        wakeMarkWritten: result.wakeMarkWritten,
        wakeMarkError: result.wakeMarkError,
        wakePrimaryDigest: result.wakePrimaryDigest,
        wakeLinkageDigest: result.wakeLinkageDigest,
        message,
      };
    } else {
      // Single claim mode

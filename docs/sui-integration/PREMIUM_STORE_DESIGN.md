# Premium Store System - Design Document

## Overview

This document outlines the design for a premium store system where players can purchase power-ups and advantages before starting a game. The store will accept payments in SUI or $MEWS tokens, and purchases will be stored on-chain for transparency and verification.

...
import { WalletReserves } from './components/WalletReserves';
import { TabNavigation } from './components/TabNavigation';
import { AdminStylesProvider } from './components/AdminStyles';
import { ItemsTab } from './tabs/ItemsTab';
import { StockroomTab } from './tabs/StockroomTab';
import { BadgesTab } from './tabs/BadgesTab';
import { InsigniaTab } from './tabs/InsigniaTab';
...
import { StatsManagementTab } from './tabs/StatsManagementTab';
import { GamePassManagementTab } from './tabs/GamePassManagementTab';
import { SoundTestTab } from './tabs/SoundTestTab';
import dynamic from 'next/dynamic';

// Lazy load GameConfigTab to prevent blocking wallet API initialization
const GameConfigTab = dynamic(
  () => import('./tabs/GameConfigTab').then((mod) => ({ default: mod.GameConfigTab })),
  {
    ssr: false,
  }
);
...
export default function AdminPage() {
  ...
  return (
    <AdminStylesProvider styles={styles}>
      <div style={{ 
        minHeight: '100vh',

// Robust contract deployment with connection testing and retry logic
...
async function testConnection(url, timeout = 10000) {
  try {
    ...
    // Try to get the latest checkpoint as a connection test
    await Promise.race([
...
// Create a client (timeout is handled per-operation via retryOperation)

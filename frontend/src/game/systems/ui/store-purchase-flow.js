...
async function proceedToPurchase() {
  ...
  try {
    ...
    // Paid fulfillment is routed on-chain through the platform inventory/settlement path; the game backend then settles to the app admin wallet.
    ...
    // Reload catalog; inventory refresh runs in background via PlayerInventoryCache (purchase already invalidated API cache)

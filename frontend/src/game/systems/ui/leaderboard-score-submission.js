...
async function saveScore() {
  ...
  // Names are optional. Allow blank names to be saved/submitted.
  // For local leaderboard readability we use a display fallback later.
  ...
  try {
    ...
    // No local leaderboard: only on-chain submission drives leaderboard.

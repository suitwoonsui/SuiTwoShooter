...
/**
 * Display badge in UI (main menu badge panel, etc.)
 * @param {HTMLElement} container - Container element to display badge in
 * @param {Object} badgeData - Badge data from API
 * @param {string} walletAddress - Wallet address (used for upgrade flow)
 * @param {{ forceRefreshStats?: boolean }} [options] - Reserved for callers; stats are not shown in-badge.
 */
function displayBadgeInUI(container, badgeData, walletAddress = null, options = {}) {
  void options;

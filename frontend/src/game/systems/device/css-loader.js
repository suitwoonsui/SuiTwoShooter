...
const CSSLoader = {
  ...
  async loadSharedCSS() {
    ...
    // Store modal tabs + panel visibility, inventory tab, Game Pass tab in store, end-demo + menu stat displays
    await this.loadCSS('src/game/rendering/ui/store-inventory-ui.css');
